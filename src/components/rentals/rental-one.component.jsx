        ...
        <div class="card w-full bg-base-100 shadow-xl justify-items-center">
            ...
            <div class="card-body items-center lg:px-60">
                ...
                <p>
                    ...
                    Sleeps 6 guests. The daily rental rate is $125/day (2-day
                    minimum). The weekly rental rate is $500. The monthly rental
                    rate is $750. All rates include utilities. (Rates are based
